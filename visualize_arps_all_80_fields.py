"""
Visualize ARPS Yield Predictions for All 80 Fields
...
def create_arps_ranked_plot():
    ...
    # Save figures
    output_png = 'yield_arps_all_80_fields_ranked.png'
    plt.savefig(output_png, dpi=300, bbox_inches='tight')
    print(f"\n✓ Saved plot to: {output_png}")
    
    output_pdf = 'yield_arps_all_80_fields_ranked.pdf'
...
def create_arps_boxplot():
    ...
    # Save figures
    output_png = 'yield_arps_all_80_fields_boxplot.png'
    plt.savefig(output_png, dpi=300, bbox_inches='tight')
    print(f"✓ Saved boxplot to: {output_png}")
    
    output_pdf = 'yield_arps_all_80_fields_boxplot.pdf'
    plt.savefig(output_pdf, bbox_inches='tight')
    print(f"✓ Saved PDF to: {output_pdf}")
...
if __name__ == "__main__":
    print("\n" + "=" * 80)
    print("CREATING ARPS YIELD VISUALIZATIONS - ALL 80 FIELDS")
    print("=" * 80)
    ...
    try:
        ...
        print("=" * 80)
        print("\nCreated files:")
        print("  - yield_arps_all_80_fields_ranked.png")
        print("  - yield_arps_all_80_fields_ranked.pdf")
        print("  - yield_arps_all_80_fields_boxplot.png")
        print("  - yield_arps_all_80_fields_boxplot.pdf")
