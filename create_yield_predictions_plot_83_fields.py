"""
Create a comprehensive yield predictions plot for all 83 fields.
"""
...
def create_yield_predictions_plot():
    """Create a beautiful yield predictions plot for all 83 fields."""
    
    print("=" * 80)
    print("CREATING YIELD PREDICTIONS PLOT - ALL 83 FIELDS")
    print("=" * 80)
    ...
    # Save figures
    output_png = 'yield_predictions_all_83_fields.png'
    plt.savefig(output_png, dpi=300, bbox_inches='tight')
    print(f"\n✓ Saved plot to: {output_png}")
    
    output_pdf = 'yield_predictions_all_83_fields.pdf'
    plt.savefig(output_pdf, bbox_inches='tight')
    print(f"✓ Saved PDF to: {output_pdf}")
    
    plt.close()
    
    # Also create a compact boxplot version
...
def create_boxplot_version(df, mean_yield, median_yield, q1_yield, q3_yield, min_yield, max_yield):
    """Create a compact boxplot version."""
    ...
    # Save
    output_png = 'yield_predictions_all_83_fields_boxplot.png'
    plt.savefig(output_png, dpi=300, bbox_inches='tight')
    print(f"✓ Saved boxplot to: {output_png}")
    
    output_pdf = 'yield_predictions_all_83_fields_boxplot.pdf'
    plt.savefig(output_pdf, bbox_inches='tight')
    print(f"✓ Saved PDF to: {output_pdf}")
...
if __name__ == "__main__":
    try:
        create_yield_predictions_plot()
        
        print("\n" + "=" * 80)
        print("✓ YIELD PREDICTIONS PLOT CREATED SUCCESSFULLY")
        print("=" * 80)
        print("\nGenerated files:")
        print("  - yield_predictions_all_83_fields.png")
        print("  - yield_predictions_all_83_fields.pdf")
        print("  - yield_predictions_all_83_fields_boxplot.png")
        print("  - yield_predictions_all_83_fields_boxplot.pdf")
